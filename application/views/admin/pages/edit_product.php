...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <i class="icon-edit"></i>
            <a href="<?php echo base_url('edit/product/'.$product_info_by_id->product_id)?>">Edit Produk</a>
        </li>
    </ul>
            ...
            <div class="box-content">
                <form name="formName" class="form-horizontal" action="<?php echo base_url('update/product/'.$product_info_by_id->product_id);?>" method="post" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Stock</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Brand Produk</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span6 typeahead" value="0" name="product_feature" id="fileInput" type="radio"/> Tidak Unggulan
                                <input class="span6 typeahead" value="1" name="product_feature" id="fileInput" type="radio" />Unggulan
                            </div>
                        </div>
