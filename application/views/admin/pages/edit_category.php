...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <i class="icon-edit"></i>
            <a href="<?php echo base_url('edit/category/'.$category_info_by_id->id)?>">Edit Kategori</a>
        </li>
    </ul>
                ...
                <form class="form-horizontal" action="<?php echo base_url('update/category/'.$category_info_by_id->id);?>" method="post">
                    <fieldset>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Nama Kategori</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="textarea2">Deskripsi Kategori</label>
                            <div class="controls">
