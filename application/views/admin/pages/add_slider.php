...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <i class="icon-edit"></i>
            <a href="<?php echo base_url('add/slider')?>">Tambah Slider</a>
        </li>
    </ul>
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon edit"></i><span class="break"></span>Tambah Slider</h2>
                <div class="box-icon">
                ...
                <form class="form-horizontal" action="<?php echo base_url('save/slider');?>" method="post" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Judul Slider</label>
                            <div class="controls">
                         ...
                         <div class="control-group">
                            <label class="control-label" for="fileInput">Gambar Slider</label>
                            <div class="controls">
                         ...
                         <div class="control-group">
                            <label class="control-label" for="fileInput">Link Slider</label>
                            <div class="controls">
                        ...
                        <div class="form-actions">
                            <button type="submit" id="save_category" class="btn btn-primary">Simpan Perubahan</button>
