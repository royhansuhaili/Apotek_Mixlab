...
<html lang="en">
    <head>
        ...
        <!-- start: Meta -->
        <meta charset="utf-8">
        <title>Panel Login Apotek Mixlab</title>
        <meta name="description" content="Panel Login Apotek Mixlab">
        <meta name="author" content="Kelompok2">
        <meta name="keyword" content="Panel Login Apotek Mixlab">
        <!-- end: Meta -->
        ...
        <!-- start: Favicon -->
        <link rel="shortcut icon" href="<?php echo base_url()?>assets/admin/img/ikon.jpg">
        <!-- end: Favicon -->
                    ...
                    <div class="login-box">
                        ...
                        <form id="adminlogincheck" class="form-horizontal" action="<?php echo base_url()?>admin_login_check" method="post">
                            <fieldset>
                                ...
                                <div class="input-prepend" title="Email Pengguna">
                                    <span class="add-on"><i class="halflings-icon user"></i></span>
                                    <input class="input-large span10" value="<?php set_value('user_name');?>" name="user_email" id="user_email" type="text" placeholder="ketik email pengguna"/>
                                </div>
                                <div class="clearfix"></div>

                                <div class="input-prepend" title="Password Pengguna">
                                    <span class="add-on"><i class="halflings-icon lock"></i></span>
                                    <input class="input-large span10" name="user_password" id="user_password" type="password" placeholder="ketik password"/>
                                </div>
                                <div class="clearfix"></div>
                        ...
                        <h3>Lupa Password?</h3>
                        <p>
                            Tidak Masalah, <a href="#">klik disini</a> untuk mendapatkan password baru.
                        </p>	
                    </div><!--/span-->
                </div><!--/row-->
