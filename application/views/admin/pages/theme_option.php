...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <i class="icon-edit"></i>
            <a href="<?php echo base_url('theme/option')?>">Tambahkan Opsi Tema</a>
        </li>
    </ul>
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon edit"></i><span class="break"></span>Tambahkan Opsi Tema</h2>
                <div class="box-icon">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="<?php echo base_url('save/option')?>" method="post" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Fav icon</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Info Copyright</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Info Kontak Nomor 1</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Info Kontak Nomor 2</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Link Facebook</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Link Twitter</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Link Google Plus</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Link Email</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <h2>Halaman Informasi Kontak</h2>
                            </div>
                        </div> 
                        
                        
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Judul Kontak</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Kontak Subtitle</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Deskripsi Kontak</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Informasi Perusahaan</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Nomor Telepon Apotek</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Alamat Email Apotek</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Twitter</label>
                            <div class="controls">
