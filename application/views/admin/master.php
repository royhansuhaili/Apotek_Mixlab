...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Dashboard Admin Apotek Mixlab">
    ...
    <body>
        ...
        <div class="container-fluid-full">
            <div class="row-fluid">
                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a href="<?php echo base_url('add/brand')?>"><i class="icon-edit"></i><span class="hidden-tablet"> Tambah Brand</span></a></li>
                            <li><a href="<?php echo base_url('manage/brand')?>"><i class="icon-list-alt"></i><span class="hidden-tablet"> Kelola Brand</span></a></li>
                            ...
                            <li><a href="<?php echo base_url('theme/option');?>"><i class="icon-align-justify"></i><span class="hidden-tablet"> Opsi Tema</span></a></li>
                            <li><a href="<?php echo base_url('manage/order');?>"><i class="icon-calendar"></i><span class="hidden-tablet"> Kelola Pesanan</span></a></li>
                        </ul>
                    </div>
                </div>
                <!-- end: Main Menu -->
                ...
                <div class="alert alert-block span10">
                    ...
                    <p>Anda butuh <a href="http://en.wikipedia.org/wiki/JavaScript" target="_blank">JavaScript</a> diaktifkan untuk menggunakan situs ini.</p>
                </div>
                </noscript>
        ...
        <div class="modal hide fade" id="myModal">
            ...
            <div class="modal-body">
                <p>Di sini pengaturan dapat dikonfigurasi...</p>
            </div>
